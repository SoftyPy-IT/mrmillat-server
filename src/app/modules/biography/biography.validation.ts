    ...
    items: z
      .array(
        z.object({
          ...
          itemTitle: z.string({ invalid_type_error: "itemTitle must be a string" }).optional(),
          itemDescription: z.string({ invalid_type_error: "itemDescription must be a string" }).optional(),
        })
      )
      .optional(),
  }),
