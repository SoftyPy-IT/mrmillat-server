...
const createJourneyToPolitics = catchAsync(
  async(req,res)=>{
    const JourneyToPolitics = req.body; 
    const result = await JourneyToPoliticsServices.createJourneyToPoliticsIntoDB(JourneyToPolitics); 
...
const getAllJourneyToPolitics = catchAsync(
  async(req,res)=>{
...
const getSingleJourneyToPolitics = catchAsync(
  async(req,res)=>{
    const {id} = req.params;  
    const result = await JourneyToPoliticsServices.getSingleJourneyToPoliticsFromDB(id); 
    if (!result) {
...
const updateJourneyToPolitics = catchAsync(
  async(req,res)=>{
    const {id} = req.params; 
    const JourneyToPolitics = req.body; 
    const result = await JourneyToPoliticsServices.updateJourneyToPoliticsFromDB(id,JourneyToPolitics); 
    if (!result) {
      throw new Error("JourneyToPolitics not found");
    }
    sendResponse(res,{
...
const deleteJourneyToPolitics = catchAsync(
  async(req,res)=>{
    const {id} = req.params; 
    const result = await JourneyToPoliticsServices.deleteJourneyToPoliticsFromDB(id); 
    if (!result) {
      throw new Error("JourneyToPolitics not found");
    }
    sendResponse(res,{
