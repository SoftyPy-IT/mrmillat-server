...
import { TBanner, TCompany, TConcernIssues, TContact, TElectionCampaign, TFeatures, TMission, TOurConcernIssue, TVision, TWhoWeAre } from "./features.interface";
...
const FeaturesSchema = new Schema<TFeatures>(
  {
    ...
    whoWhoAre: { type: WhoWeAreSchema, required: true },
