...
const OurConcernIssueSchema =z.object({
  title: z
    .string({
...
const WhoWeAreValidationSchema =z.object({
  title: z
    .string({
      invalid_type_error: "Title must be a string",
    })
...
const ElectionCampaignValidationSchema =z.object({
  title: z
    .string({
      invalid_type_error: "Title must be a string",
    })
...
const MissionValidationSchema =z.object({
  title: z
    .string({
...
const VisionValidationSchema =z.object({
  title: z
    .string({
...
const FeaturesUpdateValidationSchema = z.object({
  body: z.object({
    ...
    whoWhoAre: WhoWeAreValidationSchema,
